<nav class="navbar navbar-expand-lg bg-secondary text-uppercase top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href={{ url ('/') }}>SELAMAT DATANG</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-2 px-0 px-lg-3 rounded js-scroll-trigger" href={{ url('walikelas') }}>Wali Kelas</a>
          </li>
          <li class="nav-item mx-0 mx-lg-1">
